...
<ul>
  ...
  <li>「最近実行されたキー操作」とは、3秒間キー操作が無かった時点から現在までのキー操作です</li>
  <li>3秒間キー操作をしなかった後で「abc」と入力し、すかさず <img src="again.png" height=20> を押すと再度「abc」が入力されます</li>
  <li>3秒待ちたくない場合はCtrl-Lを入力します</li>
